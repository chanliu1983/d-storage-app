...
// Copy IDL file
const idlSource = path.join(
  __dirname,
  "..",
  "target",
  "idl",
  "flexible_token_exchange.json"
);
...
const typesSource = path.join(
  ...
  "target",
  "types",
  "flexible_token_exchange.ts"
);
const typesDest = path.join(typesDir, "flexible_token_exchange.ts");
fs.copyFileSync(typesSource, typesDest);

console.log(
  "Successfully copied flexible_token_exchange IDL and types to web-app/src/target/"
);
